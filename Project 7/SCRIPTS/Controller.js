...
function onEditBtnClicked(id) {
    ...
    $("#filmEditArea").css("display", "block");
...
function addTableItem(film) {
    ...
    cell.innerHTML = "<button type='button' id='editBtn" + film.id + "'>Edit</button>";
    
    cell = row.insertCell(4);
    cell.innerHTML = "<button type='button' id='deleteBtn" + film.id + "'>Delete</button>";
